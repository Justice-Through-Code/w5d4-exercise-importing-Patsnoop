...
my_song = {'artist': 'Rise Against', 'title': 'The Approaching Curve'}
add_song(my_playlist, my_song)
'''
...
my_song2 = {'artist': 'System of a Down', 'title': 'Spiders'}
my_song3 = {'artist': 'Tool', 'title': 'The Pot'}
